...
public class EnchancedVisionActivity extends CameraActivity implements ImageReader.OnImageAvailableListener {
    ...
    public void onPreviewSizeChosen(final Size size, final int rotation) {
        ...
        trackingOverlay.addCallback(
                canvas -> enchancedVisionDetectionHandler.draw(canvas));
